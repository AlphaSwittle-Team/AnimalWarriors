...
public abstract class MutantWarrior extends EntityMob implements IMutantIdentifier {
	private static final IEntitySelector attackEntitySelector = new MutantWarriorSelector();

	public MutantWarrior(World par1World)
	{
		super(par1World);
